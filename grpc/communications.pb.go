...
type Message struct {
	...
	NodeId        string                 `protobuf:"bytes,1,opt,name=nodeId,proto3" json:"nodeId,omitempty"`   // user id
	Clock         int32                  `protobuf:"varint,2,opt,name=clock,proto3" json:"clock,omitempty"`    //Logical clock
...
const file_communications_proto_rawDesc = "" +
	"\n" +
	"\x14communications.proto\"Q\n" +
	"\aMessage\x12\x16\n" +
	"\x06nodeId\x18\x01 \x01(\tR\x06nodeId\x12\x14\n" +
	"\x05clock\x18\x02 \x01(\x05R\x05clock\x12\x18\n" +
	"\acontent\x18\x03 \x01(\tR\acontent2/\n" +
	"\x0eRicartArgawala\x12\x1d\n" +
	"\aRequest\x12\b.Message\x1a\b.MessageB\x03Z\x01.b\x06proto3"
...
var file_communications_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_communications_proto_goTypes = []any{
	(*Message)(nil), // 0: Message
}
var file_communications_proto_depIdxs = []int32{
	0, // 0: RicartArgawala.Request:input_type -> Message
	0, // 1: RicartArgawala.Request:output_type -> Message
